...
Am1 = 1; %Amplitude of First Message Signal
fm1 = 2; %Frequency of First Message Signal
m1 = Am1*cos(2*pi*fm1*t); % First Message Signal
Am2 = 2; %Amplitude of Second Message Signal
fm2 = 3; %Frequency of Second Message Signal
m2 = Am2*cos(2*pi*fm2*t); % Second Message Signal
Am3 = 3; %Amplitude of Third Message Signal
fm3 = 4; %Frequency of Third Message Signal
